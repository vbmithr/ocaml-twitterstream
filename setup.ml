...
(* OASIS_START *)
(* DO NOT EDIT (digest: 69f95d712622ab4b29361cf7787ebd4f) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Stream interface to Twitter API";
          description = None;
          categories = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "twitterstream.ml"; })
            ];
          plugins =
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "@\237l\224\248i\166\251\172\196\154J\189\197?\001";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
